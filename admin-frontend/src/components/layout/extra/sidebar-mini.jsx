...
const SidebarMini = () => {
  ...
  return (
    <div className="layout-fixed sidebar-expand-lg sidebar-mini bg-body-tertiary">
            ...
            <div className="container-fluid">
              <div className="row">
                <div className="col-sm-6">
                  <h3 className="mb-0">Sidebar Mini</h3>
                </div>
                <div className="col-sm-6">
                  <ol className="breadcrumb float-sm-end">
                    <li className="breadcrumb-item"><a href="#">Home</a></li>
                    <li className="breadcrumb-item active">Sidebar Mini</li>
                  </ol>
                </div>
              </div>
            </div>
