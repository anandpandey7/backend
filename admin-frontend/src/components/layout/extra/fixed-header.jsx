...
const FixedHeader = () => {
  ...
  return (
    <div className="fixed-header sidebar-expand-lg sidebar-open bg-body-tertiary">
            ...
            <div className="container-fluid">
              <div className="row">
                <div className="col-sm-6">
                  <h3 className="mb-0">Fixed Header</h3>
                </div>
                <div className="col-sm-6">
                  <ol className="breadcrumb float-sm-end">
                    ...
                    <li className="breadcrumb-item active">Fixed Header</li>
                  </ol>
                </div>
              </div>
            </div>
